...
public class YCor extends TurtleQueryBlock implements TurtleCommandBlock {
	
	public YCor(Deque<RootBlock> queue) {
		super(queue);
	}
	...
	public double evaluate(IProjectManager pm) throws BlockArgumentsException {
		...
		// TODO: Determine if:
		// return pm.getTurtleBundle().evaluate(myString).getY();
		// is a better idea
	}
